...
- generic [ref=e3]:
  ...
  - generic [ref=e135]:
    - generic [ref=e139]:
      - generic [ref=e140]:
        - generic [ref=e141]:
          - heading "manda Messi" [level=6] [ref=e143]
...
```ts
  ...
  33 |   }
  34 | 
  35 |   async expectDatosPersonalesActualizados(datosPersonales) {
> 36 |     await expect(this.inputNombre).toHaveValue(datosPersonales.nombre);
     |                                    ^ Error: expect(locator).toHaveValue(expected) failed
  37 |     await expect(this.inputApellido).toHaveValue(datosPersonales.apellido);
  38 |   }
  39 | }
  40 | 
```