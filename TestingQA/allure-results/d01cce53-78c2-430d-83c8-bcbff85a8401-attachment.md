...
Locator: getByRole('heading', { name: 'Alberto Messi' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Alberto Messi' })
...
- generic [ref=e3]:
        ...
        - list [ref=e123]:
          - listitem [ref=e124]:
            - generic [ref=e125] [cursor=pointer]:
              ...
              - paragraph [ref=e127]: Roderick Hayes
              - generic [ref=e128]: 
  ...
  - generic [ref=e135]:
    - generic [ref=e139]:
      - generic [ref=e140]:
        - generic [ref=e141]:
          - heading "Roderick Hayes" [level=6] [ref=e143]
        ...
        - generic [ref=e169]:
          ...
          - generic [ref=e172]:
            - generic [ref=e176]:
              ...
              - generic [ref=e179]:
                - textbox "First Name" [ref=e182]: Roderick
                - textbox "Middle Name" [ref=e185]: Maureen
                - textbox "Last Name" [ref=e188]: Hayes
            - separator [ref=e189]
            - generic [ref=e190]:
              - generic [ref=e191]:
                - generic [ref=e193]:
                  - generic [ref=e195]: Employee Id
                  - textbox [ref=e197]: EMP7330
                - generic [ref=e199]:
                  - generic [ref=e201]: Other Id
                  - textbox [ref=e203]: OTH9913
              - generic [ref=e204]:
                - generic [ref=e206]:
                  - generic [ref=e208]: Driver's License Number
                  - textbox [ref=e210]: DL6338493
                - generic [ref=e212]:
                  - generic [ref=e214]: License Expiry Date
                  - generic [ref=e217]:
                    - textbox "yyyy-dd-mm" [ref=e218]: 2029-19-11
...
```ts
  ...
  10 |     this.botonGuardarNombreCompleto = page
  11 |       .locator("form")
  12 |       .filter({ hasText: "Employee Full NameEmployee" })
  13 |       .getByRole("button");
  14 |   }
  15 | 
  16 |   async expectLoaded() {
  17 |     await expect(this.page).toHaveURL(/viewPersonalDetails/);
  18 |     await expect(this.enlaceMiInfo).toHaveClass(/active/);
  19 |     await expect(this.inputNombre).toBeVisible();
  20 |     await expect(this.inputApellido).toBeVisible();
  21 |   }
  22 | 
  23 |   async completarNombreYApellido(datosPersonales) {
  24 |     await this.inputNombre.clear();
  25 |     await this.inputNombre.fill(datosPersonales.nombre);
  26 | 
  27 |     await this.inputApellido.clear();
  28 |     await this.inputApellido.fill(datosPersonales.apellido);
  29 |   }
  30 | 
  31 |   async guardarDatosPersonales() {
  32 |     await this.botonGuardarNombreCompleto.click();
  33 |   }
  34 | 
  35 |   async expectNombreCompletoVisible(datosPersonales) {
  36 |     await expect(
  37 |       this.page.getByRole("heading", {
  38 |         name: `${datosPersonales.nombre} ${datosPersonales.apellido}`,
  39 |       }),
> 40 |     ).toBeVisible();
     |       ^ Error: expect(locator).toBeVisible() failed
  41 |   }
